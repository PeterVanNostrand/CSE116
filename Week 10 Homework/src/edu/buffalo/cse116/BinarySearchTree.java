...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractSet<E> {
  ...
  /**
   * When we are removing a node that has a child, we need the child to replace that node in the tree. This method will
   * switch any links so that they are no longer to it's parent.
   *
